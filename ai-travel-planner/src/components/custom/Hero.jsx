...
<section className="py-20 bg-gradient-to-b from-gray-50 to-gray-100 px-6">
  ...
  <p className="text-lg text-gray-600 text-center mb-12 max-w-3xl mx-auto">
    Discover breathtaking places across the globe. From city skylines to tropical escapes — 
    let AI curate your next adventure.
  </p>
...
<section className="py-24 bg-gradient-to-br from-indigo-50 via-blue-50 to-indigo-100 px-6 relative overflow-hidden">
  <h2 className="text-5xl font-extrabold text-center mb-16 text-gray-800 drop-shadow-sm">
...
},
{
  ...
  img: "user3.jpg",
      ...
      <div
        key={idx}
        className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transform hover:-translate-y-2 transition duration-500 text-center border border-gray-100"
      >
        <img
          src={`/${review.img}`}
          alt={review.name}
          className="w-20 h-20 rounded-full mx-auto mb-4 object-cover border-4 border-indigo-100 shadow-md"
        />
