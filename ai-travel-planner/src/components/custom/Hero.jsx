...
function Hero() {
  return (
    ...
    >
      ...
      {/* Subtext */}
      <p className="text-base sm:text-lg md:text-xl text-gray-200 text-center max-w-2xl leading-relaxed mt-4">
        Your <span className="font-semibold">personal travel curator</span> — 
        creating{" "}
        <span className="font-semibold">custom itineraries</span> tailored to your{" "}
        ...
        you just enjoy the <span className="italic text-green-300">journey ✈️</span>.
      </p>
